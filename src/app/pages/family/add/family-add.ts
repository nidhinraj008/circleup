...
import { addFamily, selectFamilyById, selectLargestFamilyId, updateFamily } from '../store'
import { selectPersonsWithAge } from '../../person/store'
import { take } from 'rxjs';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
import { CommonData } from '../../../shared/services/common-data';
import { addFamilyMember, removeFamilyMembersByFamilyId, selectLargestFamilyMemberId, selectFamilyMembersByFamilyId } from '../store/family-members'
...
export class FamilyAdd {
  ...
  private getAllPersons() {
    this.store.select(selectPersonsWithAge).pipe(takeUntilDestroyed(this.destroyRef)).subscribe(res => {
